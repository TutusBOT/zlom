...
public class Physical3DButton : MonoBehaviour, IInteractable
{
    ...
    public void OnHoverEnter()
    {
        ...
        if (_buttonRenderer != null && hoveredMaterial != null && !_isBeingPressed && !_buttonActivated)
        {
    ...
    public void OnHoverExit()
    {
        ...
        if (_buttonRenderer != null && normalMaterial != null && !_isBeingPressed && !_buttonActivated)
        {
            _buttonRenderer.material = normalMaterial;
        }
    }
