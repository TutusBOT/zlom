...
public class Generator3D : MonoBehaviour {
    ...
    void PlaceCube(Vector3Int location, Vector3Int size, Material material) {
        Vector3 adjustedPosition = location + new Vector3(size.x / 2.0f, size.y / 2.0f, size.z / 2.0f);
        GameObject go = Instantiate(cubePrefab, adjustedPosition, Quaternion.identity);
